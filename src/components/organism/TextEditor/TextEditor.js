  ...
  return (
    <>
      ...
      <div className={styles["left-items"]}>
        <div  className={styles["first-div"]}>
          ...
          <span>
          <select name="width" id="change-width" value={selectedWidth} onChange={(event)=>setSelectedWidth(event.target.value)}>
            <optgroup label="">
        ...
        <select name="font" id="change-font" value={selectedFont} onChange={(event)=>setSelectedFont(event.target.value)}>
            <optgroup label="">
        ...
        <div className={styles["fifth-div"]}>
          ...
          <span className={styles[""]}>
            <MdOutlineTextFormat size={20} onClick={handleColorChangeClicked}/>
          </span>
          <span className={styles[""]}>
        ...
        <div className={styles["seventh-div"]}>
            ...
            </span>
           {
            isAlign &&
            (<span>
                <span><MdFormatAlignLeft onClick={handleAlignLeft}/></span>
                <span> <MdFormatAlignRight onClick={handleAligRightClicked}/> </span>
                <span> <MdFormatAlignCenter onClick={handleAlignCenter}/></span>
            </span>)
      ...
      <div className={styles["right-items"]}>
        ...
        <span><MdOutlineModeEditOutline/></span> <span>Editing  </span>
    ...
    <div className={styles["page-box"]} ref={contentRef} >
      <div className={styles["page"]}style={{width:selectedWidth}} >
        <div>
            <textarea style={{fontSize:`${count}px`,fontFamily:`${selectedFont}`,color:color}} id="myTextArea" className={`${isBoldClicked?styles["text-bold"]:""} ${isItalicClicked?styles["text-italic"]:""} ${isUnderLineClicked?styles["text-underLine"]:""} ${isAlignRightClicked?styles["text-right"]:""} ${isAlignLeftClicked?styles["text-left"]:""} ${isAlignCenter? styles["text-center"]:""}` }
